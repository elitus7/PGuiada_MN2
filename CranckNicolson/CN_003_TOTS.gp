...
# Llegenda
plot "Resultats_CN1.dat" using 2:1 with lines title "Relació de mallat = 1.0", \
     "Resultats_CN_05_03.dat" using 2:1 with lines title "Relació de mallat = 0.5", \
