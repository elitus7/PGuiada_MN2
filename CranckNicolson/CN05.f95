program CN05
    ...
    OPEN(unit=10, file="Temperatura_CN_05.dat", status="replace")
        DO i = 1, 101
            WRITE(10,*) Tn(i)*674 - 273.15
        END DO
    !Creem un arxiu .dat on guardem els valors de Tn desnormalitzats
    OPEN(unit=10, file="Temps_CN_05.dat", status="replace")
        DO i = 1,5
            WRITE(10,*) (0.02)*(i-1)
        END DO
        !Creem un arxiu .dat que generi els diferents valors del temps
    OPEN(unit=10, file="Resultats_CN_05.dat", status="replace")
        DO i = 1, 101
