...
set format x "%.1f"
# Llegenda
plot "Resultats_Eulimp_1.dat" using 2:1 with lines title "Relació de mallats = 1.0", \
     "Resultats_Eulimp05_03.dat" using 2:1 with lines title "Relació de mallats = 0.5", \
