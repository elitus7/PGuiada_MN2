...
# Llegenda
plot "Error_EEx_025.dat" with lines lc rgb "red" lw 2 title "Relació mallat = 0,25", \
     "Error_EEx_049.dat" with lines lc rgb "blue" lw 2 title "Relació mallat = 0,49", \
