...
set output 'eexp_tfinal_g025+g049.png'
...
# Llegenda
plot "eulex_results_f_g025.dat" with lines title "Euler Explícit 0.25", \
     "eulex_results_f_g049.dat" with lines title "Euler Explícit 0.49", \
