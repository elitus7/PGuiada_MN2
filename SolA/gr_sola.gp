...
set output 'gr_sola.png'
set title "Temperatura vs. Posició al temps final t=0.025 s"
set ylabel "Temperatura (ºC)"
set xlabel "Posició (cm)"
set xrange[0:2]
set yrange[0:60]
set grid
set key at screen 0.765, 0.165 center font "Cambria, 10" # Posició de la llegenda
