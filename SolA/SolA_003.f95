program sola003
    ...
    open(unit=10, file="resultats_003.dat", status="replace")
    ...
    call system("copy resultats_003.dat C:\\Users\\juuns\\Documents\\GitHub\\PGuiada_MN2\\error")
